...
<!-- 
   <div class="dropdown btn-area">
    <select name="forma" onchange="location = this.value;" class="btn btn-primary dropdown-toggle btn-float-right" data-toggle="dropdown">
        ...
        <option value="year_income.php" selected> This Year </option>
    </select>
    </div> -->
            ...
            <div class="col-md-12">
                <div class="income-table mt-5">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th colspan="4" style="text-align: center;">This Year Income List</th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                   ...
                   <th colspan="2">Total This Year Income</th>
                   <th>
