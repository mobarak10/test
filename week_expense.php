...
$query = "SELECT * FROM expense_description WHERE date_time > 'DATE_SUB(NOW(), INTERVAL 1 WEEK)';";
            ...
            <div class="col-md-12">
                <div class="income-table mt-5">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th colspan="4" style="text-align: center;">This Week Expense List</th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                   ...
                   <th colspan="2">Total This Week Expense</th>
                   <th>
