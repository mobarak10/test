...
<div class="col-md-6">
    ...
    <select name="forma" onchange="location = this.value;" class="btn btn-primary dropdown-toggle btn-float-right" data-toggle="dropdown">
        ...
        <option value="month_income.php" selected> This Month </option>
            ...
            <div class="col-md-12">
                <div class="income-table mt-5">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th colspan="4" style="text-align: center;">This Month Income List</th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                   ...
                   <th colspan="2">This Month Income</th>
                   <th>
